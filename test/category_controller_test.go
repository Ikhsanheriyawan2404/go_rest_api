...
// func setTestDBSipodes() *sql.DB {
// 	db, err := sql.Open("mysql", "admin:admin@(127.0.0.1:3306)/sipodes")
// 	helper.PanicIfError(err)
...
// func GetWisata(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
...
// func TestApiSipodes(t *testing.T) {
// 	db := setTestDB()
// 	truncateCategory(db)
// 	router := httprouter.New()

// 	router.GET("/api/v1/wisata", GetWisata)
// }
...
func TestFindByIdCategorySucces(t *testing.T) {
	db := setTestDB()
	truncateCategory(db)
